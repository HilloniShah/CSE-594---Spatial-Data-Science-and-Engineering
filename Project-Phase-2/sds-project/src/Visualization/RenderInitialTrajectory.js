...
export default function RenderInitialTrajectory(
  props,
  {
  ...
  const layers = [
    ...
    new TripsLayer({
      ...
      getColor: (d) => {
        switch (d.vehicle_id % 4) {
          case 0:
            return theme.trailColor0;
          case 1:
            return theme.trailColor1;
          case 2:
            return theme.trailColor2;
          case 3:
            return theme.trailColor3;
        }
      },
      opacity: 0.9,
      widthMinPixels: 2,
...
export function renderToDOM(container) {
  render(<RenderInitialTrajectory />, container);
}
